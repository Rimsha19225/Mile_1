...
(() => {
    ...
    form.addEventListener("submit", (e) => {
        ...
        const educationHTML = Array.from(educationGroups).map(group => {
            ...
            return `<p><strong>${degree}</strong> - ${institution} (${year})</p>`;
        }).join("");
...
function addEducation() {
    ...
    group.innerHTML = `
    <input type="text" name="degree" placeholder="Degree (e.g. BS-HRM)" required />
...
function addExperience() {
    ...
    <textarea name="eperience" placeholder="Eperience" required></textarea>
  `;
    container === null || container === void 0 ? void 0 : container.appendChild(group);
}
